...
def test_move_right():
    text_box = py_cui.widgets.TextBox('id', 'Test', grid_test, 1, 1, 1, 2, 1, 0, logger, 'Hello World', False)
...
def test_move_right_overflow():
    text_box = py_cui.widgets.TextBox('id', 'Test', grid_test, 1, 1, 1, 1, 1, 0, logger, 'Hello World!!!', False)
    for _ in range(0, 20):
        text_box._move_right()
