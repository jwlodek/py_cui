...
def test_move_right():
    text_box = py_cui.widgets.TextBox('id', 'Test', grid_test, 1, 1, 1, 2, 1, 0 , 'Hello World', password = False)
    text_box.move_right()
...
def test_move_right_overflow():
    text_box = py_cui.widgets.TextBox('id', 'Test', grid_test, 1, 1, 1, 1, 1, 0 , 'Hello World!!!', password = False)
    for i in range(0, 20):
        text_box.move_right()
