...
class PopupExample:
    ...
    def __init__(self, master):
        ...
        self.show_message_popup         = self.master.add_button('Show FileDialog Popup',      0, 0, command=self.show_message)
    ...
    def show_message(self):
        ...
        self.master.show_filedialog_popup('Hello!', callback=exit)
